...
flowchart TD
    ...
    START --> INTAKE["<br/>- Pulls the Epic via <b>Helix MCP</b>, produces <b>epic-brief.md</b><br/>- Brownfield: gathers current-system knowledge from <b>Atlas</b> into <b>atlas-deep-dive.md</b>"]
    ...
    STORIES --> PLAN["<b>Execution Planning</b><br/>- Maps story dependencies<br/>- Decides which design stages this Epic needs"]
    ...
    MORE -->|Yes| SIGNOFF["<b>Story Sign-off (ve-list-work)</b><br/>- VE runs each story's test plan against the merged code<br/>- If VE finds a bug, it rejects the story and logs it via <b>/raise-defect</b>"]

    SIGNOFF --> EPIC_PR["<b>Epic Release</b><br/>- User runs <b>/pr-generator</b><br/>- Framework raises the final Epic pull request<br/>- Creates a <b>release archive</b>"]
