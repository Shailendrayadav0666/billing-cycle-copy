...
description: >
  ...
  a mandatory user Approval Gate on the Planner's own plan output (specs/<story-slug>.md) -> invoke
...
```
.aire-rule-details/agents/playwright-implement-agent.md
```

That file in turn loads and executes:

```
.aire-rule-details/extensions/testing/playwright-automation/playwright-automation.md
```
