...
description: >
  ...
  pass — one artifact set at .spec/aire-docs/planning/reverse-engineering/ covering ALL
...
- If `.spec/aire-docs/` does not exist, create the minimal structure first
...
- Log the invocation, completion, and user approval in `.spec/aire-docs/audit.md`
